...
import { Memory88 } from './components/memory88'

import {Running} from './components/AmazingPage/Running'
...
function App() {
    ...
    return (
        <>
            ...
            <Navbar/>
            <Routes>
                <Route exact path='/' element={<Running />} />
                ...
                <Route exact path='/memory88' element={<Memory88 />} />
